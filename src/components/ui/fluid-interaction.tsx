...
export function FluidInteraction({
  ...
  return (
    ...
    >
      {/* 固定漸層背景 - 始終作為底層，不做透明度變化 */}
      <div
        className="absolute inset-0"
        style={{
          background: `radial-gradient(ellipse at center, ${hexToRgba(color, opacity * 0.8)} 0%, transparent 70%)`,
        }}
        aria-hidden="true"
        suppressHydrationWarning
      />

      {/* Three.js Canvas 容器 - 僅此層做淡入動畫 */}
      <div
        ref={containerRef}
        className="absolute inset-0"
        style={{
