    ...
    <main className="relative">
      ...
      <section id="about" className="relative min-h-screen flex items-center justify-center bg-gradient-to-b from-amber-50 via-orange-50/40 to-amber-100/60 py-20 px-6">
        ...
        <article className="relative max-w-4xl mx-auto">
          ...
          {/* 分隔線 */}
          <div className="w-24 h-px bg-gradient-to-r from-transparent via-amber-600 to-transparent mx-auto mb-12" />
          ...
          <div className="space-y-8 text-stone-700 leading-loose">
            ...
            <p className="text-lg md:text-xl text-center md:text-left font-light leading-relaxed" style={{ letterSpacing: '0.03em', lineHeight: '2' }}>
              在靈鷲山，<br className="md:hidden"/>我們守護著廣欽老和尚<span className="whitespace-nowrap">「老實念佛、折服我慢」</span>的苦行風範，<br className="md:hidden"/>延續著四大名山慈悲接引的千年傳承。<br className="md:hidden"/>但我們走得更遠——在山海交會的聖地，<br className="md:hidden"/>我們將這份體力的磨練，轉化為<br className="md:hidden"/><span className="whitespace-nowrap">「心和平，世界就和平」</span>的當代導引。
            </p>
