...
export function FadeCarousel({
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      ...
      {/* 左箭头 - 桌面版居中，手机版在底部 */}
      <button
        className={`absolute left-5 z-20 flex h-12 w-12 items-center justify-center rounded-full bg-black/40 text-white backdrop-blur-sm transition-all hover:bg-black/60 focus:outline-none focus:ring-2 focus:ring-white ${
          isReady ? "opacity-100" : "opacity-0"
        } top-1/2 -translate-y-1/2 md:top-1/2 md:-translate-y-1/2 max-md:top-auto max-md:bottom-8 max-md:translate-y-0`}
        onClick={handlePrev}
      ...
      {/* 右箭头 - 桌面版居中，手机版在底部 */}
      <button
        className={`absolute right-5 z-20 flex h-12 w-12 items-center justify-center rounded-full bg-black/40 text-white backdrop-blur-sm transition-all hover:bg-black/60 focus:outline-none focus:ring-2 focus:ring-white ${
          isReady ? "opacity-100" : "opacity-0"
        } top-1/2 -translate-y-1/2 md:top-1/2 md:-translate-y-1/2 max-md:top-auto max-md:bottom-8 max-md:translate-y-0`}
        onClick={handleNext}
